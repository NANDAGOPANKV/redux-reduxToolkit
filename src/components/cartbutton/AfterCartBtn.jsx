...
export const AfterCartBtn = () => {
    ...
    return (
        <div className='flex items-center justify-around '>
            {
                setCount === 1 ? <p className='cursor-default mx-1 bg-rose-500 px-2 py-1 rounded ' onClick={() => dispatch(normal())} >X</p> : <button className='mx-1 bg-rose-500 px-3 py-1 rounded ' onClick={() => dispatch(decrement())} >-</button>
